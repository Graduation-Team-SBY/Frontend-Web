        ...
        <div className="w-1/2">
          ...
          {order.workerId ? (
            <div className="flex">
              ...
              <button className="btn bg-[#1D204C] text-white rounded-full mt-10">
                <svg
              ...
              <Link to={`/jalu/order/${order._id}/verification`} className='btn bg-[#1D204C] text-white rounded-full mt-10'>Konfirmasi selesai</Link>
            </div>
          ) : (
            <button
